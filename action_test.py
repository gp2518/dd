...
# Function to draw landmarks with different styles
...
actions = np.array(['hello', 'exec1', 'exec2'])
    ...
    while cap.isOpened():
        ...
        if len(sequence) == 30:
            ...
            if res[np.argmax(res)] > threshold:
                ...
                if detected_action == 'exec1':
                    gesture_actions.open_notepad()
                elif detected_action == 'exec2':
                    gesture_actions.close_notepad()
                elif detected_action == 'hello':
                    gesture_actions.type_hello()
